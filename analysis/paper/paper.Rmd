...
Ishinomoto 8-ku 
the age of the EUP oc- cupation falls within the interval 39,690–34,790 cal BP.the Takuma upland in Kumamoto Prefecture A total of 500 lithic specimens were recovered from the lithic concentrations. The lithic raw materials are mainly chert and andesite. The lithic assem- blage includes trapezoids, side scrapers, flakes, flake cores, edge-ground axes, and cobble tools
...
[@izuho201421; ]
 ...
 vegetation during MIS 3 (Takahara and Hayashi), large mammal extinctions in the late Pleistocene (Iwase et al.), colonization processes of the Ryukyu Islands (Kaifu et al.), marine transport of obsidian from the Kozu Island (Ikeya), introduction of new lithic tools from the Korean Peninsula (Morisaki), trap-pit hunting (Sato), Jōmon mitochondrial DNA (Adachi et al.), and the di- versification processes of the microblade technocomplex in Hokkaido (Nakazawa and Yamada)
 
 “circular aggregations” (dense concentrations of stone artifacts aligned in a circle), . High-quality lithic raw mate- rials, such as obsidian, “hard shale,” and sanukite, were often transported long distances and used together with locally available chert, andesite, rhyolite, and chalcedony.

high quarlity raw materials were avaliable (70 obsidian sources). the Aira-Tn (AT) tephra, dated at 30,009±189 cal BP (Smith et al. 2013) (1) the archeological components are situated below the primary AT tephra level (>30,000 cal BP), and (2) the tool kit usually (butnot always) includes trapezoids, pointed-shaped backed blades (“knife-shaped tools” in previous terminology), and edge-ground axes. the stratigraphical chronology is based on Sagamihara Upland and Mt. Ashitaka area

only a few possi- bly pre-UP sites are known, and there is ongoing, heated debate whether or not such archaic industries existed in the Japanese archipelago
