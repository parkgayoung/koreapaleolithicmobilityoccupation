...
```{r}
#I couldn't find the most recent map that you made. I assume that you don't share the code, but showed me the image so that I just copied it for SAA poster
#This is what I made first before you made the recent one

korean_archaeological_sites <- readxl::read_excel("~/koreapaleolithicmobilityoccupation/korean-archaeologica-sites.xlsx")
