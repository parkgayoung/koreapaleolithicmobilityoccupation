...
<<!-- dp we need to mention popular research topic such as existance of pre UP ("archaic industries")as a heated debate?--->>

The Late Pleistocene technological transition in Korea is mainly characterized by the early appearance of stemmed points, followed by blade technology. The stemmed point is a projectile point made out of elongated flake or blade and with slight retouch on the proximal end to shape an acute tip and on the distal end to make a stem, which connects to a shaft. The earliest stemmped points were made on flakes. After blades appear at c. 27 ka, the shape of stemmped points became more standardized with one or two ridges on dorsal side and triangular cross section. The stemmed point is often called as a tanged point in western hemisphere, but we use 'stemmed point' to distinguish from Bronze Age stone projectile points in Korea that have long been called 'tanged points'. Stemmed points were made from blade blanks, and became more standardized and increased in quantity over time. Flake tools became more complex, with a greater diversity in both type and size along with continuously used core tools during the Late Pleistocene  [@Bae_2010; @Lee_2013; @Lee_2016]. The oldest stemmed points so far is from the Yongho-dong site dated to 38.5 ka [@seong2009emergence; #### Park 2012 ####; @seong2015diversity; @bae2017origin]. The origin of the stemmed point is one of the most frequently devated topic related to the modern human dispersals. Bae (2010) claims two sub-stages for these new technologies based on the presence of AT tephra (presumably earlier than 25k BP). Bae’s earlier stage is started from Koreyri site dated to 27 ka. The stage is characterized by long and thick blades and relatively large prismatic cores with stemmed points. Bae’s later stage contains a microlithic industry, for example as found at Sinbuk in southwestern Korea, which dates 25,420±190 BP and 25,000±1,000 BP [@bae2010origin]. An alternative view comes from Seong (2009) and Park (2012) who claim three sub-stages by distinguishing an initial period when stemmed points appeared before blades [@seong2009emergence; #### Park 2012 ####]. The difference between the two stages of division [@bae2010origin] and the three stages [@seong2009emergence; #### Park 2012 ####] hinges on the recognition of stemmed points as a technology that is distinctive from blades. Bae stresses the combination of stemmed point and blade as tool blanks, while Seong and Park focus on the stemmed point as a new technology, having a stem part with retouch and acute-angled tip. These different perspectives on the distinctiveness of the stemmed point are at the crux of a heated debate on the nature and cause of the transition from the earlier phase to the later phase during the Late Pleistocene.
