...
The appearance of stemmed points in the Late Pleistocene (~40-35 ka) in Korea is often assumed to have transformed forager lifeways because it it thought to reflect more specialed hunting practices (citations). Stemmed points are considered to be projectile weapon tips because the stem of these tools is cconsidered to represent halfting technology that joins the lithic to a wooden shaft. Stemmed points represent the first appearance of halfting technology in Korea. Here we explore questions about these transformations using behavioural ecology to investigate changes in the way people used the landscape, and the way people used sites. We examined stone artifacts from 22 sites in South Korea to investigate the technological transition represented by the appearance of a new tool, stemmed points, and the blade industry that followed. Previous work on this technological change has focussed on issues of the transition from the Early to the Late Paleolithic and the disperal of _Homo sapiens_ (citations). To our knowledge, the implications for forager mobility and site use have not been explored. Most Korean Paleolithic sites do not preserve organic remains to understand forager subsistence economies, so we lack direct faunal evidence on hunting strategies. We attempt to identify patterns of mobility through analysis of the stone artefact assemblages using Human Behavioral Ecology (HBE) models. Drawing on established relationships between lithic technology and forager mobility (citations, Shott, Kuhn) we hypothesize that the appearance of the new hunting tool might reflect a preference for more portable and efficient technologies, that are part of a broader strategy of moving frequently and further, possibly as an adaptation to population or environmntal changes. 

<!--
Need something about connection between stemmed point and specifics of hunting, what kind delivery system? What kind of game?
-->
...
<!-- one equal-sized paragraph for each of our three questions, with lots of recent, specific citations for each Q 
 
State the questions very clearly and give background into relevant literature:

 -  the population: that some relationship may exist between population as a cause of techno change: Torrence, Collard, Shennan
 
 - the way people used the landscape: changing mobility patterns due to risk management,  Kelly, Fitzhugh, Shott
 
 - the way people used sites: more fine-grained evidence about land use patterns long vs short term durations of site use Kuhn, Andresfsky, Hiscock
 

-->

We ask two questions to invetigate the period around the introduction of stemmed points. First, we are asking how the introduction of the new tools changed forager landscape use, specifically, was the use of stemmed points associated with occupation of marginal or exterme environments? The new technology might allow hunter-gatherers to explore and stay in different or harsher territories by increasing mobility as well as innovating foraging strategies. In addition, the new tool production technique required hunter-gatherers to move for acquiring specific raw materials [@blumenschine2008effects; @reti2016quantifying]. According to ethnographic observations of mobility, people move frequently with little knowledge of the places for foraging and acquiring raw materials purpose with portable, mulifunctional, long lasting tools[@clarkson2008lithics;@kuhn2014mousterian]. The study reported here was designed to interpret the impact of the new tools on the landscape use during the transitional period. 

<!-- I think we were also talking about example that a new tech actually changed the landscape. But I'm not sure where I can put the example

For example, the new technology could change their landscape. Hominin fire use in the early Pleistocene has been studied and some argue that usage of fire changed the landscape and their dietary [@pruetz2010brief; @glikson2013fire; @parker2016pyrophilic; @hlubik2019hominin].

-->

Second, we focus on how the new technology changed the way people use their sites whether they tended to stay in one spot longer as a base campe or shorter period for specific purpose such as summer hunting camp. The stone artifact assemblage from a site can inform us how long individuals or groupd stayed or what they did there so we can assume the way people use the site [@binford1979organization; @kelly1995foraging; @kuhn2016moves; @holdaway2019surface]. Stone artifact contains a record of material transport and selection because it was carefully designed so that people could make a living from the landscape that constraints the production, efficiency, use, transportation, and maintenance [@clarkson2008lithics]. Archaeological sites indicate depositional phenomena and places where artifacts and other debris accumulated reflecting human activities in the past [@kuhn2015artifact]. This project will look into stone assemblages that hunter-gatherers left behind to understand the site occupation pattern change during the transition period and the relationship with the appearance of new tools.
...
#k_kas_sites_sheets <- map(p_sheets, ~path %>% )
