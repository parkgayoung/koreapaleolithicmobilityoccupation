...
<!-- this is what I'm newly writing 
In this research, we try to answer the three questions to understand the technological transition period. First, we are asking how the introduction of the new tools changed the usage of landscape. The new technology might allow hunter-gatherers to explore and stay in different or harsher territories by increasing mobility as well as innovating hunting strategies []. Or people could change their landscape using the new tools such as []. 
According to ethnographic observations of mobility, people move frequently with little knowledge of the places for foraging and acquiring raw materials purpose with portable, mulifunctional, long lasting tools[@clarkson2008lithics;@kuhn2014mousterian]. The study reported here was designed to 

Second, we focus on how did the new technology change the way people use their sites whether they tended to stay in one spot longer as a base campe or shorter period for specific purpose such as summer hunting camp. The stone artifact assemblage from a site can inform us how long individuals or groupd stayed or what they did there so we can assume the way people use the site. It is because a stone artifact
contains a record of material transport and selection and it was carefully designed so that people could make a living from the landscape that constraints the production, efficiency, use, transportation, and maintenance [@clarkson2008lithics]. This project will look into stone assemblages that hunter-gatherers left behind to understand the site occupation pattern change during the transition period and the relationship with the appearance of new tools.
...
- Site is a place where past activity is preserved with material evidence.
