...
<!-- we grouped the stone artefacts into 33 assemblages based on the depositional context and chronology... We grouped together similar stratigraphic units into one assemblage... the appearance of new artefact types such as stemmed points and blades were used to separate assemblages in the same site. For example... one site that is an example of how you identified multiple assembalges in site -->
...
ggsave(here("analysis/figures/site-elevation-by-age.png"))
```
