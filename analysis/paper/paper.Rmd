...
# zoom in in on the 40-33ka period GP is trying
spd_test_zoom <- modelTest(spd_dates,errors=dates_clean$error,timeRange=c(40000,33000),model='exponential',nsim=200,ncores=3)
