...
The origins of Late Pleistocene technological innovations in Japan is debated due to the uncertainty about the existence of people in the Archipelago before the appearance of new tools 

[@izuho201421; ]

. New technologies are represented by systematic procurement and reduction of lithic raw materials, trap-pit hunting methods, watercraft, bow-and-arrow technology, and standardization of lithic tools [@bae2017origin]. <!-- need some ages for these types of evidence --> These have been interpreted as evidence of new foraging strategies possibly driven by increased population and ecological changes [@Yamaoka_2012; @bae2017origin; @Nakazawa_Bae_2018; @morisaki2019early]. <!-- need to expand, mention some key site, blades appear when? what is the debate? -->
